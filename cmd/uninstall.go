...
var uninstallPhpmyadminCmd = &cobra.Command{
	Use:   "phpmyadmin",
	Short: "Uninstall phpMyAdmin web interface",
	Run: func(cmd *cobra.Command, args []string) {
		installer.UninstallPhpMyAdmin()
	},
}
...
func init() {
	...
	uninstallCmd.AddCommand(uninstallPhpmyadminCmd)
