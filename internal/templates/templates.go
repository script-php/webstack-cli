...
//go:embed nginx/* apache/* mysql/* php-fpm/* error/* dns/* mail/*
var FS embed.FS
...
// GetMailTemplate reads a mail server template
func GetMailTemplate(filename string) ([]byte, error) {
	return GetTemplate("mail/" + filename)
}
